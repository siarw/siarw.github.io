...
In general, the [lightcurve]({filename}/lightcurves-of-small-solar-system-bodies.md) of an object tells us both how fast [it spins]({filename}/the-rotational-properties-of-kuiper-belt-objects.md) and [how]({filename}/the-shapes-of-kuiper-belt-objects.md) [elongated it is]({filename}/the-shapes-of-kuiper-belt-objects.md). We can use this information to infer how "strong" an object is. The word strong is in quotes because the strength can have different origins.
...
![Rotating Ellipsoid]({static}/images/2013/09/65d95.gif) 
...
![Figure 1 — Observed (+'s) and model (solid line) lightcurves, and rotating shape model for Kuiper belt object Varuna. The derived density based on the shape model and spin period (P = 6.3442 hr) is approximately ρ = 1 g/cm\^3.]({static}/images/2013/03/2013-04-08-varuna-lightcurve.png)
