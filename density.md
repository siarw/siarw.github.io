...
In general, the [lightcurve]({filename}/lightcurves-of-small-solar-system-bodies) of an object tells us both how fast [it spins]({filename}/the-rotational-properties-of-kuiper-belt-objects) and [how]({filename}/the-shapes-of-kuiper-belt-objects) [elongated it is]({filename}/the-shapes-of-kuiper-belt-objects). We can use this information to infer how "strong" an object is. The word strong is in quotes because the strength can have different origins.
